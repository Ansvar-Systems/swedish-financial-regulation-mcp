...
const SERVER_NAME = "swedish-financial-regulation-mcp";
...
const TOOLS = [
  {
    name: "se_fin_search_regulations",
    description:
    ...
    inputSchema: {
      ...
      properties: {
        ...
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., FI_FFFS, FI_PROMEMORIOR). Optional." },
        status: {
          type: "string",
  ...
  {
    name: "se_fin_get_regulation",
    description:
      "Get a specific Swedish financial regulation provision by sourcebook and reference.",
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., FI_FFFS, FI_PROMEMORIOR)" },
        reference: { type: "string", description: "Provision reference (e.g., 'FFFS 2014:1 kap.2 para.1')" },
      },
      required: ["sourcebook", "reference"],
    },
  },
  {
    name: "se_fin_list_sourcebooks",
    description: "List all Swedish financial regulation sourcebooks with names and descriptions.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "se_fin_search_enforcement",
    description:
      "Search Finansinspektionen enforcement actions — ingripanden, sanktionsavgifter, and anmarkningar.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  {
    name: "se_fin_check_currency",
    description: "Check whether a specific Swedish financial regulation provision reference is currently in force.",
    inputSchema: {
      type: "object" as const,
      properties: {
...
function createMcpServer(): Server {
  ...
  server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
      switch (name) {
        case "se_fin_search_regulations": {
        ...
        case "se_fin_search_enforcement": {
        ...
        case "se_fin_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "Swedish Financial Regulation MCP server. Provides access to Finansinspektionen (FI) FFFS foreskrifter, promemorior on operational resilience, and enforcement decisions.",
            data_source: "Finansinspektionen (https://www.fi.se/)",
